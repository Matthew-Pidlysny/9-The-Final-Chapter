# Update 2: January 4, 2026 - Still haven't talked to any of you, if any has been fooled please disregard those fools, you are NOT talking to me.  Also, we are organizing a fun Protest/Get Together.  Operate it as you all communally get along, and just set up some kind of Exposition using whatever hardware you can get your hands on.  You'll have to take ownership seriously, but we'll call it "SunVenture Technology Exposition", and we'll expose the whole repository, you bring your work and do your best to show mine.  No obligation for mine, but really show how the products have evolved.  Call it "The Great Day of Mathematics" in the paper :)  Good luck all, I cannot help but wish the event the best, consider it official in any way you arrange via the repo.
...
At any rate, I will definitely announce my salesman.  I just need the boost in reality, and can't seem to get it anywhere, or so I pretend.  Commonly, people just do things, right?  And why not me?  I guess I get a bit fearful doing normal things these days.  But that can be OK, everyone things I'm fucking around when really I'm suffering like a champ.  Here's my problem:

1) For years, the LEO environment has been shuffling periodically to prevent continuous knowledge, not increase security.  Everyone today is new in that regard.

2) The radio bursts keep happening, and I keep saying they're happening, but no inferometers get placed, and when they do, the room shuffles.

3) Pruning has been going on for a long time, meaning important information is not getting to where it needs to be.

4) There is ALWAYS, 100% of the time, the presence of the US army complicit in all shutdown affairs.

These things are true, whether people see them or not.  I wish everyone to know how displeased God is, and I prove it.  Why, isn't it so that I only:

1)  Need to get the Business License (Corporate)
2)  Acquire a lender for the IPO by showing my initial clones for popularity spike and current demand
3)  Place all software and research into a trust
4)  Register the company on the stock market
5)  Provide security for the establishment

I think I can do that, but if I would be excommunicated I would believe nobody could sue me for not communicating to them, and providing them with dividends.  If that were stopped, hypothetically there would be a reason, and screenshots to prove I received nothing of the sort.  Why, I guess my idea would just be fluff to me, and I registered for nothing, meanwhile everybody is waiting for me to pay out and no money has come in.  Where did it go?  I will find out about that, but these are my issues.  
