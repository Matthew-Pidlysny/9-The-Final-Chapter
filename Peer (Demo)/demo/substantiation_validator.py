...
class SubstantiationValidator:
    ...
    def _determine_validation_level(self, math_analysis: Dict, comp_verification: Dict) -> Tuple[ValidationLevel, float]:
        ...
        if math_analysis["algebraic_validity"]["valid"]:
...
Analysis: {result.substantiation_explanation.split('PEER MATHEMATICAL ASSESSMENT:')[1].split('\n')[0] if 'PEER MATHEMATICAL ASSESSMENT:' in result.substantiation_explanation else 'Complete'}
"""
